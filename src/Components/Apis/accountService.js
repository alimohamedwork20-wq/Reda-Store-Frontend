...
export const accountService = {
  ...
  DeleteAddress: (addressId) => apiClient.delete("Account/delete-address", { data: { addressId } }),
  SetDefaultAddress: (addressId) => apiClient.post("Account/set-default-address", { addressId }),
  ...
  AddUser: (formData) => apiClient.post("WebServices/add-user", {
    Name: formData.name,
